...
import {View,Text,SafeAreaView,FlatList,KeyboardAvoidingView,
...
const Chat = ({ route, navigation }) => {
  ...
  return (
    <SafeAreaView style={[globalStyle.flex1, { backgroundColor: color.CHATBOX_PURPLE }]}>
      <KeyboardAvoidingView
        keyboardVerticalOffset={deviceHeight > smallDeviceHeight ? 100 : 70}
        behavior={Platform.OS === "ios" ? "padding" : "height"}
        style={[globalStyle.flex1, { backgroundColor: color.CHATBOX_PURPLE }]}
      >
        ...
        >
          <Fragment>
            <FlatList inverted data={messeges} keyExtractor={(_, index) => index.toString()} 
            renderItem={({ item }) => (
